...
export const Education = () => {
  return (
    <main className='container3 mt-8 mb-20'>
        ...
        {/* education content */}
        <Row className='education-content gap-y-4 mx-14 my-14' style={{display:'flex',justifyContent:'space-between',alignItems:'center'}}>
            {/* collage */}
            <Col xs={23} sm={16}  md={11} lg={11} className='ug px-5 py-8 rounded-lg'>
            ...
            {/* higher secondary */}
            <Col xs={23} sm={16}  md={11} lg={11} className='higher-secondary px-5 py-8  rounded-lg'>
